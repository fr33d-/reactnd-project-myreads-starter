            ...
            <div className="list-books-content">
              <div>
                ...
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
	                    {this.state.books.filter((b) => b.category == "currently" ).map(book => ( <Book book={book} onDeleteBook={this.handleChange} /> ))}
                    </ol>
                  </div>
                </div>
				...
				<div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
                      {this.state.books.filter((b) => b.category == "want" ).map(book => ( <Book book={book} onDeleteBook={this.handleChange} /> ))}
                    </ol>
                  </div>
                </div>
                ...
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
                    	{this.state.books.filter((b) => b.category == "read" ).map(book => ( <Book book={book} onDeleteBook={this.handleChange} /> ))}
                    </ol>
                  </div>
                </div>
